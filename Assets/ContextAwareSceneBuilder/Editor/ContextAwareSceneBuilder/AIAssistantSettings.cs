...
namespace ContextAwareSceneBuilder.Editor
{
    ...
    public class AIAssistantSettings : ScriptableObject
    {
        ...
        private const string SETTINGS_PATH = "Assets/ContextAwareSceneBuilder/Settings/AIAssistantSettings.asset";
        ...
        public string PrefabScanFolder = "Assets/ContextAwareSceneBuilder/Examples/Prefabs";
    ...
    public class AIAssistantSettingsEditor : UnityEditor.Editor
    {
